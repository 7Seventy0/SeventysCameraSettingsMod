...
public class FlyCamera : MonoBehaviour 
{
    ...
    string CodeBox = "ABC";
    string GameobjectFinder = "Player";
    GameObject uiCanvas;
    bool uiIsShown = true;
    ...
    IEnumerator LateStart()
    {
        ...
        uiCanvas.GetComponent<TabGroup>().PopulateTabList(GameObject.Find("CompTab"));
    ...
    void OnGUI()
    {
        if (uiIsShown)
        {
            ...
            GameobjectFinder = GUI.TextArea(new Rect(10, 100, 200, 20), GameobjectFinder, 200);

            if (GUI.Button(new Rect(10, 125, 100, 30), "Track"))
                if(GameObject.Find(GameobjectFinder) != null)
                {
                    playerToTrackArenaMode = GameObject.Find(GameobjectFinder).transform;
                }
        ...
        if(uiCanvas == null)
        {
          //  Debug.Log("###########nnnnnnnnnnnnnnnnnnnnnnnnnn#############");
           ...
           // Debug.Log("###########nnnnnnooooooooooooooooooooooooooooooonnnnnnn#############");
            ...
            GameObject.Find("CompTABButton").AddComponent<TabButton>();
    ...
    Vector3 firstpersonOffset = new Vector3(17,50f,-5);
    ...
    void Update () 
    {
      ...
      if(rig == null)
        {
            rig = GameObject.Find("Actual Gorilla").GetComponent<VRRig>();
        }
     ...
     //  Debug.Log(")))))))))))eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee)))))))))))))))))))))))))))))))))");
       ...
       // Debug.Log("))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))");
        ...
        if (lookAtToggle.state && !isFPSview && playerToTrackArenaMode != null)
        {
   ...
   //     Debug.Log("ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ");
      ...
      // Debug.Log("OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO");
        ...
        if (isFPSview)
        {
            if (transform.parent != rig.playerOffsetTransform.transform)
                transform.SetParent(rig.playerOffsetTransform.transform);

            transform.position = Camera.main.transform.position;
                transform.rotation = Quaternion.Lerp(transform.rotation, Camera.main.transform.rotation, smoothing * 1.6f);
        }
        if (!isFPSview)
        {
            allowedToMove = true;
     ...
     //   Debug.Log("VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV");
        ...
        if (Keyboard.current.oKey.wasPressedThisFrame && points.Count > 0)
        {
        ...
        else
        {
                ...
                transform.position = Vector3.MoveTowards(transform.position, pointTransform.position, 0.2f);
